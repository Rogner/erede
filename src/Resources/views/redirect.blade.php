...
<head>
    ...
    <title> {{ __('shop::app.checkout.onepage.title') }}</title>
...
<body>
    <div class="payment-title">
        {{-- <h1>Pagamento <span style="display: block; font-size: 14px;">Cartão de Crédito</span></h1> --}}
    </div>
    <form action="{{ route('erede.pay') }}" method="post" id="pay" name="pay">
        <div class="header">
                        ...
                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg"
                            ...
                            C0,17.9,17.9,0,40,0z" />
                                ...
                                <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">JOHN
                                    DOE</text>
                                <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">Nome
                                    do Titular</text>
                                <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">Validade</text>
                                <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">Número do
                                    Cartão</text>
                                <g>
        ...
        ">@if ($errors->any())
            ...
            <div class="radio-list">
                <div style="float: left; margin-left: 50px;">
                    <input type="radio" checked name="kind" value="credit">
                    <label for="male">Cartão de Crédito</label><br>
                </div>
                <div style="float: right; margin-left: 50px;">
                    <input type="radio" name="kind" value="debit">
                    <label for="female">Cartão de Débito</label><br>
                </div>
            </div>
            <div class="form-container">
                <div class="field-container">
                    <label for="name">Nome do Titular</label>*
                    <input id="name" name="name" maxlength="20" type="text" value="John Snow">
                </div>
                <div class="field-container">
                    <label for="cardnumber">Número do Cartão</label><span style="display: none;"
                ...
                <div class="field-container">
                    <label for="expirationdate">Validade (mm/yyyy)</label>
                    <input id="expirationdate" name="expirationdate" type="text" placeholder="12/2030"
                        inputmode="numeric" value="12/2020">
                </div>
                <div class="field-container">
                    <label for="securitycode">Código de Segurança</label>
                    <input id="securitycode" name="securitycode" type="text" inputmode="numeric" value="235">
                </div>

            </div>
            <div
                style="font-size: 28px; font-weight: 600; text-align: right; color: darkslategray; margin-top: -10px; margin-right: 20px;">
                <label>Total:</label> {{ core()->currency($cart->base_grand_total) }}
            </div>
        </div>
        <input class="btn btn-lg btn-primary" type="submit" value="Finalizar" />
        <div style="text-align: center; margin-top: 15px; padding-bottom: 2px; margin-bottom: 0.67em;">
            <a style="color: slategray; text-decoration: none;" href="{{ route('shop.checkout.cart.index') }}">Retornar
                para o carrinho</a>
        </div>
    </form>
</body>
